...
public class ColoredComputer {
    ...
    private ColoredComputer (ColoredComputerBuilder builder){
    ...
    public static class ColoredComputerBuilder extends ComputerDesign implements ActionListener {
        private JFrame frame;
        private JButton button;
        private JTextField number1field;
        private JLabel number1label;
        ...
        public ColoredComputerBuilder(String Background_color, String Text_color) {
            this.color1 = Color.decode(Background_color);
            this.color2 = Color.decode(Text_color);
            this.frame = Frame();
