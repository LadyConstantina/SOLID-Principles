...
public class DollarCreditCard extends CreditCard{

    private double Money;
    private List<String> Transaction_History = new ArrayList<String>();

    public DollarCreditCard(){
        this.Money = 0;
    }

    public DollarCreditCard(double money){
        this.Money = money;
    }

    private DollarCreditCard(double money,List<String> history){
        this.Money = money;
    ...
    public CreditCard Clone(){
        ...
        return new DollarCreditCard(money_to_new_wallet,Transaction_History_Temp);
    }
